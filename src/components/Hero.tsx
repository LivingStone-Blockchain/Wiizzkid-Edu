        ...
        {heroData.map(({id, tagline, text, colorDeep, colorLight, shadow, img, mobileShadow}) => (
              ...
              <div className="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
                  ...
                  <div className="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
                      ...
                      <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" className="flex flex-col gap-3 justify-center items-center bg-white rounded-lg h-24 sm:h-28 py-3 px-4 absolute bottom-14 -left-4 sm:left-2 sm:bottom-20 lg:bottom-24 lg:-left-4 floating">
