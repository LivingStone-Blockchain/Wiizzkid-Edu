  ...
  return (
    <>
      <div
        id="home"
        className={`${
          mobileDropdownOpen && "md:blur-0 blur-2xl"
        } max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start z-10 relative overflow-hidden pt-[30px] md:pt-[90px] lg:pt-[120px]`}
      ...
      >
        <div className="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
          <h1
            data-aos="fade-right"
            data-aos-once="true"
            className="my-4 text-4xl md:text-5xl lg:mx-0 mx-auto font-bold leading-tight text-navy"
          >
            We are the <span style={{ color: `${colorDeep}` }}>{tagline}!</span>
          </h1>
          <p
            data-aos="fade-down"
            data-aos-once="true"
            data-aos-delay="300"
            className="leading-normal md:text-2xl text-lg mb-8 text-navy"
          >
            {text}
          </p>
          <div className="w-full flex sm:flex-row flex-col items-center justify-center lg:justify-start sm:space-x-5">
            ...
            <button
              id="quiz-button"
              onClick={handleTryLondonMode}
              className="flex items-center z-[100] justify-center space-x-3 px-9 mt-7 sm:mt-0 rounded-full border-2 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out"
              onMouseEnter={() => setHover(true)}
              onMouseLeave={() => setHover(false)}
              style={
                hover
                  ? { borderColor: `${colorDeep}` }
            ...
            <div
              className="hidden items-center justify-center space-x-3 mt-7 md:mt-0 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out"
        ...
        <div className="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
          ...
          <div
            ...
            data-aos-delay="400"
            data-aos-once="true"
            className="absolute top-20 right-10 sm:right-24 sm:top-28 md:top-36 md:right-32 lg:top-32 lg:right-16 floating sm:block hidden"
          >
          ...
          <div
            ...
            data-aos-delay="300"
            data-aos-once="true"
            className="sm:flex hidden flex-col gap-3 justify-center items-center bg-white rounded-lg h-24 sm:h-28 py-3 px-4 absolute bottom-14 -left-4 sm:left-2 sm:bottom-20 lg:bottom-24 lg:-left-4 floating"
          >
            <div className="flex gap-4 justify-center items-center">
              <img
                className="bg-[#f25471] bg-opacity-80 rounded-lg h-auto w-full max-w-[30px] p-1"
                src={vr}
                alt="vr"
              ...
              />
              <p className="flex flex-col">
                <span className="font-semibold text-gray-500 text-[13px] tracking-wide">
                  Wiizzkid Metaverse
                </span>
                <span className="text-[11px] text-gray-500 tracking-wide font-medium">
                  Into the future
                </span>
              </p>
            </div>
            <a
              href="#metaverse"
              className="lg:mx-0 bg-[#F25471] text-white text-[11px] font-sm rounded-full py-1.5 px-6 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out cursor-pointer"
            >
              Join Now
            </a>
          </div>
