...
const SideBar:FC<SideBarProps> = ({open, setOpen, userFullName, handleLogout}) => {
  ...
  return (
    <aside
    className={`fixed top-0 z-10 ${open ? '' : 'ml-[-100%]'} flex h-screen origin-left duration-300 ${open ? 'w-4/6 scale-x-1' : 'w-0 transform lg:transform-none scale-x-0'}  flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]`}
  >
    <div className='relative'>
      {/*mobile hamburger*/}
      <button className="absolute -mr-2 h-16 w-12 lg:hidden text-[#252641]" onClick={() => setOpen(!open)}>
        <svg
      ...
      <ul className="mt-8 space-y-2 tracking-wide">
        <li>
          <Link
            ...
            className={`relative group flex items-center space-x-4 rounded-xl px-4 py-3 text-white ${pathname.includes('/dashboard-home') ? 'bg-[#252641]' : 'text-gray-600'}`}
          >
            <svg className="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
              <path
                d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z"
                className={`fill-current text-gray-600 group-hover:text-[#26a8a1] ${pathname.includes('/dashboard-home') ? 'text-[#26a8a1]' : 'text-gray-600'}`}
              ></path>
              <path
        ...
        <li>
          <Link
            ...
            className={`relative group flex items-center space-x-4 rounded-xl px-4 py-3 ${pathname.includes('/dashboard/quizzes') ? 'bg-[#252641] text-white' : 'text-gray-600'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
            ...
            >
              ...
              />
              <path
                className={`fill-current text-gray-600 group-hover:text-[#26a8a1] ${pathname.includes('/dashboard/quizzes') ? 'text-[#26a8a1]' : 'text-gray-600'}`}
        ...
        <li>
          <Link
            ...
            className={`relative group flex items-center space-x-4 rounded-xl px-4 py-3 ${pathname.includes('/dashboard/quiz-history') ? 'bg-[#252641] text-white' : 'text-gray-600'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
            ...
            >
              <path
                className={`fill-current text-gray-600 group-hover:text-[#26a8a1] ${pathname.includes('/dashboard/quiz-history') ? 'text-[#26a8a1]' : 'text-gray-600'}`}
                fillRule="evenodd"
        ...
        <li>
          <Link
            ...
            className={`relative group flex items-center space-x-4 rounded-xl px-4 py-3 ${pathname.includes('/dashboard/wiizzkid-metaverse') ? 'bg-[#252641] text-white' : 'text-gray-600'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
            ...
            >
              <path
                className={`fill-current text-gray-600 group-hover:text-[#26a8a1] ${pathname.includes('/dashboard/wiizzkid-metaverse') ? 'text-[#26a8a1]' : 'text-gray-600'}`}
        ...
        <li>
          <Link
            ...
            className={`relative group flex items-center space-x-4 rounded-xl px-4 py-3 ${pathname.includes('/dashboard/buy-token') ? 'bg-[#252641] text-white' : 'text-gray-600'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
            ...
            >
              ...
              />
              <path
                className={`fill-current text-gray-600 group-hover:text-[#26a8a1] ${pathname.includes('/dashboard/buy-token') ? 'text-[#26a8a1]' : 'text-gray-600'}`}
                fillRule="evenodd"
          ...
          >
            <svg 
                ...
                viewBox="0 0 24 24" >
                    ...
                    />
                    <g className='fill-current text-gray-600 group-hover:text-[#26a8a1]'>
            ...
            <span className="group-hover:text-[#252641] text-sm leading-relaxed font-medium ">Home</span>
          </Link>
        </li>
      </ul>
    </div>
      ...
      <button className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600" onClick={handleLogout}>
        ...
        >
            ...
            <path d="m37.8963 33.3948c-1.5092 1.2701-3.3735.4385-3.4835-1.5381-.0609-1.0945-.1141-2.4749-.146-4.2047-8.5544-.0865-15.2156-.2878-18.3328-.3961-1.0851-.0377-1.934-.9343-1.934-2.0269v-2.2444c0-1.0762.8242-1.9647 1.8922-2.0205 3.0992-.1619 9.7816-.4659 18.3742-.5963.0318-1.7388.0852-3.1255.1463-4.2241.11-1.977 1.9749-2.8087 3.4844-1.5383.8995.757 2.0084 1.7393 3.3435 3.0025 2.238 2.1175 3.5227 3.709 4.2488 4.7743.6809.9988.6808 2.2359-.0001 3.2347-.7262 1.0652-2.0109 2.6566-4.2487 4.7743-1.3355 1.2638-2.4447 2.2465-3.3443 3.0036z" 
                className='fill-current text-gray-600 group-hover:text-[#26a8a1]'
            />
        </svg>
        <span className="group-hover:text-[#252641] text-sm">Logout</span>
      </button>
    </div>
  </aside>
  )
