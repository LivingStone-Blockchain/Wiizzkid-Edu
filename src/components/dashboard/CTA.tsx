...
const CTA:FC<CTAPropType> = ({message, name}) => {
  ...
  return ( 
        <div className="relative w-full p-4 mb-8 md:text-base text-sm font-semibold text-white bg-[#252641] rounded-xl focus:outline-none border border-gray-300 overflow-hidden">
