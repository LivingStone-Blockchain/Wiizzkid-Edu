    ...
    <div  className="flex flex-col items-start justify-start">
      ...
      <div   className={`flex items-center justify-between my-3 w-full ${window.innerWidth < 380 && 'flex-col gap-5'}`}>
          ...
          {loading && (<svg role="status" className="inline mr-3 w-4 h-4 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className={`relative flex items-center justify-center md:text-base text-sm font-semibold ${loading ? " text-gray-200" : " text-white"}`}>{loading ? "Processing" : `Withdraw Winning`}</span> 
      </Button> 
