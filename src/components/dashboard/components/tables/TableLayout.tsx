...
const TableLayout = () => {
  ...
  const data = dashBoardMode
    ? useMemo(() => timestableTableData(timestableRecentGames!), [])
    : useMemo(() => quizTableData(quizRecentGames!), []);
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div
        data-aos="fade-up"
        data-aos-delay="200"
        className="overflow-auto whitespace-nowrap scrollbar-hide rounded-lg ring-1 ring-black ring-opacity-5"
      >
        {data === undefined ? (
