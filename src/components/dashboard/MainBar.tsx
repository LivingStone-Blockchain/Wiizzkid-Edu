  ...
  return (
    ...
    <div className="sticky top-0 h-16 border-b bg-white lg:py-2.5">
      <div className="flex items-center justify-between space-x-4 px-6 2xl:container">
        <h5 hidden className="md:text-2xl text-xl font-medium text-gray-600 lg:block">Dash<span className='text-yellow-500'>board</span></h5>
        <button className="-mr-2 h-16 w-12 border-r lg:hidden text-[#252641]" onClick={() => setOpen(!open)}>
          <svg
        ...
        <div className="flex space-x-4">
          <div hidden className="md:block">
            <div className="relative flex items-center text-gray-400 focus-within:text-yellow-500">
              ...
              <input
                ...
                className="outline-none w-full rounded-xl border border-gray-300 py-2.5 pl-14 pr-4 text-sm text-gray-600 transition focus:border-[#252641]"
              />
            </div>
          </div>
          <button
