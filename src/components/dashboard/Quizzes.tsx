...
const Quizzes = () => {
    ...
    return (
        <div className="flex flex-col gap-8 items-start justify-start">
            <p className='font-medium text-[#252641]'>Quizzes</p>
            <div className="grid gap-6 w-full mb-8 md:grid-cols-2">
                    ...
                    <Card key={title}>
                        <CardBody className="flex flex-col gap-4 py-5 items-center border border-gray-300 rounded-xl relative">
                            ...
                            <div className='flex  flex-col justify-center items-center gap-2 w-full'>
                                <p className="text-lg font-medium text-[#252641]">{title}</p>
                                <p className="mb-2 text-sm font-normal text-gray-600">{text}</p>
                                <Button
                                    onClick={() => navigate(`${destination}`)}
                                    children={buttonText}
                                    className='w-full text-sm w-48 bg-[#252641] mt-5 mx-auto font-semibold px-5 py-3  text-white transition text-center'
                                />
                            </div>
                        </CardBody>
                    </Card>
