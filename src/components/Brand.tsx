  ...
  return (
	<div className='flex flex-col gap-2  justify-center'>
		...
		{window.innerWidth > 1023 ? (
			...
			<div aria-label="add to slack" className="p-4 border border-gray-200  rounded-full duration-300 hover:border-green-400 hover:shadow-lg hover:shadow-lime-600/20">
			...
			<div aria-label="add to chat" className="p-4 border border-gray-200 rounded-full duration-300 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-600/20">
				<div className="flex justify-center space-x-4">
			...
			<div aria-label="add to zoom" className="p-4 border border-gray-200 rounded-full duration-300 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-600/20">
				<div className="flex justify-center space-x-4">
			...
			<div aria-label="add to zoom" className="p-4 border border-gray-200 rounded-full duration-300 hover:border-[#f6851b] hover:shadow-lg hover:shadow-orange-600/20">
				<div className="flex justify-center space-x-4">
