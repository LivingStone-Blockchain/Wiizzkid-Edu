              ...
              <header className="w-full text-gray-700">
                <div className="flex flex-col max-w-screen-xl px-8 mx-auto lg:items-center lg:justify-between lg:flex-row">
                  <div className="flex flex-row items-center justify-between md:pt-8 pt-6">
                    <div
                      className={`flex justify-center items-center border-2  h-14 w-14 rounded-lg p-1`}
                    ...
                    <button
                      className={`rounded-lg lg:hidden focus:outline-none focus:shadow-outline ${
                        mobileDropdownOpen && "pointer-events-none"
                      }`}
                  ...
                  <nav
                    className={`lg:h-auto flex flex-col flex-grow lg:items-center pb-4 lg:pb-0 lg:flex lg:justify-end lg:flex-row origin-top duration-300 ${
                      open
                        ? "h-full scale-y-1"
                  ...
                  >
                    ...
                    {user && user?.tokens && (
                      <div className="relative lg:pl-8 mt-10 mb-5 lg:mt-8 md:text-base text-sm block lg:hidden">
                        <button
                          className="flex gap-1 justify-center items-center relative z-10 rounded-full bg-white p-2 focus:outline-none border border-gray-300"
                          onClick={() =>
                        ...
                        {mobileDropdownOpen && (
                          <div
                            data-aos="fade-up"
                            data-aos-delay="100"
                            className="absolute left-0 mt-3 w-full md:w-96 z-40"
                          >
                            <div className="bg-white rounded-xl overflow-hidden shadow-xl z-50">
                              <div className="text-center p-6 bg-navy border-b relative">
                                ...
                                <div className="mt-5">
                                  <a className="border rounded-full py-2 px-4 text-xs font-normal text-gray-100 cursor-pointer">
                                    Balance:{" "}
                                    <span className="text-xl font-semibold">
                                      {Number(
                                        utils.formatEther(stBalance)
                                      ).toFixed(2)}
                                    </span>{" "}
                                    <span className="text-xs">STN</span>
                                  </a>
                                </div>
                              </div>
                              <div className="border-b">
                                <Link
                                  to="/dashboard-home"
                                  className="px-4 py-3 hover:bg-gray-100 flex"
                                  onClick={() => {
                              ...
                              <div>
                                <button
                                  className="w-full px-4 py-3 pb-4 hover:bg-gray-100 flex gap-4"
                                  onClick={() => {
                                    setMobileDropdownOpen(false);
                                    setOpen(false);
                                  }}
                                >
                                  ...
                                  <p
                                    className="text-sm font-medium text-gray-500 leading-none"
                    ...
                    <a
                      className={`${
                        mobileDropdownOpen && "blur-2xl"
                      } px-4 py-2 mt-2 md:text-base text-sm bg-transparent rounded-lg lg:mt-8 lg:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline`}
                      href="#home"
                      onClick={() => {
                        setOpen(false);
                      }}
                    ...
                    {!user && (
                      <Button
                        className={`${
                          mobileDropdownOpen && "blur-2xl"
                        } px-10 py-3 mt-2 md:text-base text-sm text-center bg-white text-gray-800 lg:mt-8 lg:ml-4`}
                        children="Login"
                        onClick={() => {
                          navigate("/login");
                          setOpen(false);
                      ...
                      <div className="relative lg:pl-8 mt-2 lg:mt-8 md:text-base text-sm hidden lg:block">
                        ...
                        {dropdownOpen && (
                          <div
                            data-aos="fade-up"
                            data-aos-delay="100"
                            className="absolute right-0 mt-3 w-72 z-40"
                          >
                            <div className="bg-white rounded-xl overflow-hidden shadow-xl z-50">
                              ...
                              <div>
                                <button
                                  className="w-full px-4 py-2 pb-4 hover:bg-gray-50 flex gap-4"
                                  onClick={() => setDropdownOpen(false)}
                                >
                                  <LogOut className="text-gray-500 h-4 w-4" />
                                  <p
