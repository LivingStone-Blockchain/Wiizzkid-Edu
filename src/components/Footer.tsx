...
const Footer = () => {
  ...
  //render based on location
    if (location.pathname !== "/" && location.pathname !== "/pricing"  && location.pathname !== "/about"  && location.pathname !== "/roadmap" && location.pathname !== "/quiz-home" && !location.pathname.includes("blogs/")) {
      return null;
  }
