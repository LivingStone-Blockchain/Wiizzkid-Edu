...
const Footer = () => {
  ...
  if (
    ...
    location.pathname !== "/quiz-home" &&
    location.pathname !== "/timestable-home" &&
      ...
      <div className="lg:container m-auto space-y-8 px-4 py-16 text-gray-600 md:px-8">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b pb-8">
          ...
          <div className="flex gap-6">
            <a
              href="https://discord.gg/YaCgS5Ms5c"
              target="blank"
              rel="noreferrer"
            ...
            <a
              href="https://twitter.com/0xLivingStone/"
              target="_blank"
              rel="noreferrer"
              aria-label="twitter"
              className="hover:text-tealLight text-gray-400"
            ...
            <a
              href="https://m.facebook.com/profile.php?id=100082081963635"
              target="_blank"
              rel="noreferrer"
              aria-label="facebook"
              className="hover:text-tealLight text-gray-400"
            ...
            <a
              href="https://linkedin.com/company/livingstoneit"
              target="blank"
              rel="noreferrer"
              aria-label="linkedIn"
              className="hover:text-tealLight text-gray-400"
        ...
        <div className="grid grid-cols-2 gap-6 sm:gap-0 md:grid-cols-3">
          <div>
            ...
            <ul className="mt-4 mb-5 md:mb-0 list-inside space-y-4 text-gray-400 text-sm">
              <li>
                <a href="#quiz" className={`transition hover:text-tealLight`}>
                  Wiizzkid Quiz
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#blog" className={`transition hover:text-tealLight`}>
                  Blog
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 mb-5 md:mb-0 list-inside space-y-4 text-gray-400 text-sm">
              <li>
                <a href="#" className="transition hover:text-tealLight">
                  Portfolio
                </a>
              </li>
              <li>
              ...
              <li>
                <Link to="/pricing" className="transition hover:text-tealLight">
                  Pricing
                </Link>
              </li>
            </ul>
