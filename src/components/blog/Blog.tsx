    ...
    <div id="blog">
        ...
        {blogData.filter((item) => item.id === blogData[0].id).map((data) => 
            <div className="lg:w-6/12 rounded-lg" key={data.id}>
                <img className="w-full rounded-xl mb-6" src={data.details.blogImg} width="500" height="300" alt={data.details.blogImg}/>
            ...
            {blogData.filter((item) => item.id !== blogData[0].id).map((data) => 
                ...
                <div className="w-4/12">
                    <div className="relative">
                        <img className="rounded-xl w-full " src={data.details.blogImg} width="500" height="300" alt={data.details.blogImg} />
                ...
                <div className="w-8/12">
                    <h1 onClick={() => navigate(`/blogs/${data.id}`)} className="text-navy text-base sm:text-lg font-semibold hover:text-teal cursor-pointer">{data.content.one.datum}</h1>
