...
const quizEndGameToast = (setLoading: (value: React.SetStateAction<boolean>) => void, setTriviaFetch: (value: React.SetStateAction<boolean>) => void, navigate: NavigateFunction, setShowCreateGameModal: (value: React.SetStateAction<boolean>) => void) => {
          ...
          <article className="text-sm">
            ...
            <div className="flex items-center mt-6 gap-2">
              ...
              <Button 
                children="End game"
                onClick={() =>
                  {toast.loading("Quitting game...", { duration: 4000 }); setTimeout(() => {toast.dismiss(); navigate('/quiz-home');  setTriviaFetch(false); setShowCreateGameModal(false)}, 4000); }
                }
