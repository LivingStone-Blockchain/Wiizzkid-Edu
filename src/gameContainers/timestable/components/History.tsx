...
import imagePicker from './function/imagePicker';
    ...
    <>
        {dataPerYear && (
            ...
            <div className="md:mb-16 mb-12 md:w-2/3 lg:w-1/2">
                <h1 className="md:text-2xl text-xl font-semibold text-navy">Your Timestable <span className="text-tomato">History</span></h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                { dataPerYear.slice(-3).map((item) => (
                     ...
                     <span className="col-span-3">
                       <img
                         src={imagePicker(item.difficulty)}
                         alt="student"
                     ...
                     <article className="col-span-9">
                       <h1 className="font-medium md:text-base text-sm text-gray-300 capitalize">{item.difficulty}</h1>
       
                       <p className='mt-1 md:text-sm text-xs  text-white'>
                         <span>score: </span> 
                         {item.score}/{item.total_attempted}
                       </p>
                     </article>
                   </section>
                )) }  
