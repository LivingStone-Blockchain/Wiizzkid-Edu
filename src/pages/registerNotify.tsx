            ...
            {data.map(({ id, img, color, mailImg }) => (
                ...
                <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                 <div className='flex flex-col justify-center items-center gap-6 w-full text-center'>
                     ...
                     <p className='sm:text-base text-sm'>If <span className='font-semibold'>{emailNotify}</span> it's not your email address, please <span onClick={() => navigate('/register')} className="underline cursor-pointer" style={{color: color}}>go back</span> and enter a correct one.</p>
                 </div>
             </div>
             </div>
