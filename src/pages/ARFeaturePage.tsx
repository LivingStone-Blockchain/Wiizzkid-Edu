...
//   const cloudinaryVideoURL = "https://asset.cloudinary.com/dvlktxrnx/04aad4d38408eae32c1c15a3af2e890c";
...
//             <video className="w-full rounded-lg md:scale-[2]">
//               {/* ref={videoRef} */}
//               {/* // https://drive.google.com/uc?id=1W8sHzG_065NSc15xjpcS4qppV2NwsEFZ */}
//               <source src={cloudinaryVideoURL} />
//               controls={false} 
//               type=""
//             </video>
...
const ARFeaturePage: React.FC = () => {
  ...
  const cld = new Cloudinary({
    cloud: {
      cloudName: 'https://asset.cloudinary.com/dvlktxrnx/04aad4d38408eae32c1c15a3af2e890c'
    }
  });

  // Create video source
  const videoSrc = cld
    .video('IMG_2837_ivgwyf')
    .quality('auto')
    .format('auto');
