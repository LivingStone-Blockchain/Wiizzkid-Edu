...
const Dashboard = () => {
      ...
      <ul className="mt-8 space-y-2 tracking-wide">
        ...
        <li>
          ...
          >
            ...
            <span className="group-hover:text-gray-700">Quizzes</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span className="group-hover:text-gray-700">Quiz History</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span className="group-hover:text-gray-700">Wiizzkid Metaverse</span>
          </a>
        </li>
        <li>
          <a
  ...
  <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    ...
    <div className="px-6 pt-6 2xl:container">
      <div
        className="flex h-[80vh] items-center justify-center rounded-xl border-2 border-dashed border-gray-300"
      >
